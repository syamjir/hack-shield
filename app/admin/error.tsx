  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      <div className="flex flex-col items-center justify-center gap-3">
        <AlertTriangle className="w-12 h-12 text-danger-a0" />
      ...
      <div className="flex gap-3 mt-6">
        {reset && (
          <Button
            onClick={() => reset()}
            className="bg-primary-a20 hover:bg-primary-a30 text-both-white-a0 flex items-center gap-2"
          >
        ...
        <Button
          ...
          variant="outline"
          className="flex items-center gap-2 text-dark-a0/70"
        >
