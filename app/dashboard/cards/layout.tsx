...
export default function IdentitiesLayout({ children }: CardsLayoutProps) {
  ...
  const tabs: Tab[] = [
    ...
    { name: "Bin", href: "/dashboard/cards/bin" },
  ];
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center ">
        <div>
          <h2 className="text-2xl font-bold text-primary-a20">Cards</h2>
          <p className="text-sm text-dark-a0/50">
            Manage your saved cards details.
          </p>
        </div>
        <Button
      ...
      {/* Identity form modal */}
      <CardForm isOpen={isModalOpen} onOpenChange={setIsModalOpen} />
    </div>
  );
}
